...
//grounded
if place_meeting(x,y+1,obj_ground) or place_meeting(x,y+1,obj_ladder) or place_meeting(x,y+1,obj_bridge) and !place_meeting(x,y,obj_bridge)
{
	grounded = true
}else if !place_meeting(x,y+1,obj_ground) and !place_meeting(x,y+1,obj_ladder) and !place_meeting(x,y+1,obj_bridge) or place_meeting(x,y,obj_bridge)
{
	grounded = false
}
